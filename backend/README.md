...
## Project Structure
    ...
    ├── testapiautoteammemb_78772  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_78772`
...
2. Clone this repo and `cd testapiautoteammemb_78772`
